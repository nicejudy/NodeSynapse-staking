...
function TimeMenu() {
    ...
    const NS_ADDRESS = addresses.NS_ADDRESS;
                ...
                {({ TransitionProps }) => (
                    <Fade {...TransitionProps} timeout={200}>
                        <div className="tooltip">
                            <Link className="tooltip-item" href={`https://app.uniswap.org/swap?inputCurrency=ETH&outputCurrency=${NS_ADDRESS}`} target="_blank">
                                <p>Buy on Uniswap</p>
                            </Link>
                            ...
                            {isEthereumAPIAvailable && (
                                <div className="add-tokens">
                                    ...
                                    <div className="tooltip-item" onClick={addTokenToWallet("NS", NS_ADDRESS)}>
