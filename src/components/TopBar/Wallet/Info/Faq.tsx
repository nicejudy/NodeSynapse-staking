...
const Faq = () => {
  const faqContent = [
    {
      title: "Why do we need UniCow in the first place?",
      content:
    ...
    },
    {
      ...
      content:
        "At a high level, UniCow consists of its protocol managed treasury, protocol owned liquidity (POL), bond mechanism, and staking rewards that are designed to control supply expansion.",
    },
    {
